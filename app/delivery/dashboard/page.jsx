          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#5A8DEE]">{stats.pending}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#40E0D0]">₹{stats.earnings.toFixed(2)}</p>
              </div>
                  ...
                  <div className="flex gap-3">
                    {order.status === 'Assigned' && (
                      <button
                        ...
                        className="flex-1 px-4 py-2 bg-gradient-to-r from-[#5A8DEE] to-[#40E0D0] text-white rounded-lg font-semibold hover:shadow-lg transition"
                      >
                        Mark as Picked Up
                      </button>
                    )}
